...
def main():
    ...
    test_names = ['Naive', 'Naive Backward', 'Naive BCT', 'Naive BCT GST',
                  'Naive BCT GST']

    test_functions = [naive_search.naive_search,
                      naive_search.naive_search_backward,
                      naive_search.naive_search_bct,
                      naive_search.naive_search_bct_gst,
                      naive_search.naive_search_gst]
    ...
    for i in range(len(test_names)):
        ax.plot(text_size_range, run_times[i], label=test_names[i])
    ...
    for i in range(len(test_names)):
        ax.plot(text_size_range, mem_usages[i], label=test_names[i])
